...
# templated_config_loader documentation build
...
from templated_config_loader import __version__ as release

# -- Project information -----------------------------------------------------

project = "templated_config_loader"
copyright = "2021, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "templated_config_loaderdoc"
...
latex_documents = [
    (
        master_doc,
        "templated_config_loader.tex",
        "templated_config_loader Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "templated_config_loader",
        "Project templated_config_loader codebase.",
        "Data-Science",
    )
]
